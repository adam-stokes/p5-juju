...
To get started initialize the Juju class:
    ...
    my $juju = Juju->new(endpoint => 'wss://192.168.122.16:17070', password => '8fdsaf0fda');
    $juju->login;
    my $juju_info = $juju->info;
    print $juju_info->{UUID};
...
There is a B<port (17070)> for accessing the machine resources.
